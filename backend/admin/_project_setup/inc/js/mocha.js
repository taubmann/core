...
function outputResult()
{
	...
	{ 
		complexity.html("Enter a Password").removeClass("weak strong stronger strongest").addClass("default");
	}
	else if (charPassword.length < minPasswordLength)
	{
		complexity.html("min. " + minPasswordLength+ " characters!").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score<50)
	{
