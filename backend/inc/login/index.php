...
if(!is_writable('login_src.php')) exit('login_src.php is not writable!');
...
";
	...
	$str = '<?'."php\n\n\$loginpics = array(\n" . implode(",\n", $out) . "\n);\n";
	file_put_contents('login_src.php', $str);
...
<form action="index.php?project=<?php echo $projectName?>" method="post">
<?php
