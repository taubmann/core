...
class Blowfish
{
	...
	function __construct ($key, $mode, $iv=null, $padding) {
		$this->mode = $mode;
	 ...
	 * @author Matt Harris
	 **/
	function encrypt($plaintext, $key, $iv=NULL, $mode=Blowfish::BLOWFISH_MODE_CBC, $padding=Blowfish::BLOWFISH_PADDING_RFC) {
		if ( $mode == Blowfish::BLOWFISH_MODE_CBC and empty($iv) ) {
			throw new Exception('CBC Mode requires an IV key');
			return;
		}
		$ciphertext = '';
		$fish = new Blowfish($key, $mode, $iv, $padding);
	 ...
	 * @author Matt Harris
	 **/
	function decrypt($ciphertext, $key, $iv=NULL, $mode=Blowfish::BLOWFISH_MODE_CBC, $padding=Blowfish::BLOWFISH_PADDING_RFC) {
		if ( $mode == Blowfish::BLOWFISH_MODE_CBC and empty($iv) ) {
			throw new Exception('CBC Mode requires an IV key');
			return;
		}
