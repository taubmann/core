...
{
	$wz = explode(':', $arr['add']);
	return '<div class="field"><label>'.$arr['label'].'</label><input id="input_'.str_replace(array('[',']'),'_',$arr['name']).'" name="'.$arr['name'].'" type="hidden" placeholder="'.$arr['placeholder'].'" value="'.htmlspecialchars($arr['value']).'" />
